...
<script>
	$(function(){
		...
		$(".clickTr").click(function(){
			...
			$.ajax({
				...
				success:function(data){
					...
					//소속학과 승인
					if(data.sb_majordepartmentsubmityn == '0'){
						htmlCode += "<td class='sub0'>승인대기</td>"; 
					}else if(data.sb_majordepartmentsubmityn =='1'){
						htmlCode += "<td class='sub1'>승인</td>";
					}else if(data.sb_majordepartmentsubmityn =='2'){
		...
		$("#trueBtn").click(function(){
			location.href="/pro/belongREQDecide?sb_no="+uniq+"&&result=1";
		});
		
		$("#falseBtn").click(function(){
			location.href="/pro/belongREQDecide?sb_no="+uniq+"&&result=2";
		});
