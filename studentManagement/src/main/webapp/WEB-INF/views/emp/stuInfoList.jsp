   ...
   <div class="x_content">
            ...
            <div class="" role="tabpanel" data-example-id="togglable-tabs">
               ...
               <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                  <li role="presentation" class="active"><a
                     ...
                     data-toggle="tab" aria-expanded="true">학생</a></li>
         ...
         <div style="text-align:right;">
               ...
               <div style="text-align:right;">
            	  ...
            	  <input type="file" class="btn btn-dark"  name="studentList" id="fileup"  />
                  <button type="button" class="btn btn-dark" onclick="insertStu(this.form);">등록</button>
                </form>
