		...
		<div>
			...
			<div class="form-group">
                 ...
                 <div class="col-md-9 col-sm-9 col-xs-12">
                   <input type="text" class="form-control" name="dep_name" value="${department.dep_name }" id="dep_name">  
                 </div>
            </div>
			<br> <br>
			<div class="form-group">
                 ...
                 <div class="col-md-9 col-sm-9 col-xs-12">
                   <input type="text" class="form-control" name="dep_engname" value="${department.dep_engname }" id="dep_engname">
                 </div>
            </div>
			<br> <br>
			...
			<div class="form-group">
                 ...
                 <div class="col-md-9 col-sm-9 col-xs-12">
                   <input type="text" class="form-control" value="${department.dep_majneedcredit }" name="dep_majneedcredit" id="dep_majneedcredit">
                 </div>
            </div>
			<br> <br>
			<div class="form-group">
                 ...
                 <div class="col-md-9 col-sm-9 col-xs-12">
                   <input type="text" class="form-control" value="${department.dep_minneedcredit }" name="dep_minneedcredit" id="dep_minneedcredit">
                 </div>
            </div>
			<br> <br>
			<div class="form-group">
                 ...
                 <div class="col-md-9 col-sm-9 col-xs-12">
                   <input type="text" class="form-control" value="${department.dep_mulcredit }" name="dep_mulcredit" id="dep_mulcredit">
                 </div>
            </div>
			<br> <br>
			<div class="form-group">
                 ...
                 <div class="col-md-9 col-sm-9 col-xs-12">
                   <input type="text" class="form-control" value="${department.dep_phone }" name="dep_phone" id="dep_phone">
                 </div>
            </div>
			<br>
		</div>
