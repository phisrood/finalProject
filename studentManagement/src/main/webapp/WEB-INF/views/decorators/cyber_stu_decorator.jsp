			...
			<div class="col-md-3 left_col">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="/common/main" class="site_title"><i class="fa fa-paw"></i>
					...
					<nav>
						...
						<ul class="nav navbar-nav navbar-right">
							<li class=""><a href="javascript:;"
								...
								aria-expanded="false"> <img src="/common/images/img.jpg"
									alt="">이수정 <span class=" fa fa-angle-down"></span>
							</a>
								<ul class="dropdown-menu dropdown-usermenu pull-right">
									<li><a href=""> 프로필</a></li>
									<li><a href=""></a></li>
									<li><a href="/common/logout"><i
							...
							<li role="presentation" class="dropdown"><a
								...
								<ul id="menu1" class="dropdown-menu list-unstyled msg_list"
									...
									<li><a> <span class="image"><img
												src="/common/images/img.jpg" alt="Profile Image" /></span> <span>
