...
<!-- 		                  <li><a><i class="fa fa-table"></i> 등록 <span class="fa fa-chevron-down"></span></a>
		                  ...
		                  <li><a><i class="fa fa-desktop"></i>증명서발급 <span class="fa fa-chevron-down"></span></a>
		                    <ul class="nav child_menu">
		                      ...
		                      <li><a href="/stu/attendCertificateInfo" target="_blank" onClick="window.open(this.href, '', 'width=1000, height=1200'); return false;">재학증명서</a></li>
		                      <li><a href="/stu/graduteCertificateInfo" target="_blank" onClick="window.open(this.href, '', 'width=1000, height=1200'); return false;">졸업증명서</a></li>
		                    </ul>
		                  </li>
