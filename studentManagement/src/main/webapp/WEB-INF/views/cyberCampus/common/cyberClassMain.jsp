...
<div class="row">
	...
	<div style="float: left; width: 99%; text-align: center;">
		<div style="border: 1px solid; float: left; width: 500px; text-align: center;">
			<h2>${lectureInfo.lb_name }Cyber Campus</h2>
		</div>
	</div>
	<div style="float: left; width: 100%;">
		<br>
							...
							<c:forEach var="notice" items="${noticeList }" varStatus="status">
								<tr>
									...
									<c:if test="${auth eq 'ROLE_PRO' }">
										...
										<td><a href="/cyberCampus/pro/cyberNoticeDetailPro?ln_no=${notice.ln_no }">${notice.ln_title }</a></td>
									</c:if>
									<c:if test="${auth eq 'ROLE_STU' }">


										<td><a href="/cyberCampus/stu/cyberNoticeDetail?ln_no=${notice.ln_no }">${notice.ln_title } </a></td>
